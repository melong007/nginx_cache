...
static ngx_core_module_t  ngx_core_module_ctx = {
    ngx_string("core"),
    ngx_core_module_create_conf,//Here,Create the ngx_core_conf_s and save into the ngx_cycle_s[]
    ngx_core_module_init_conf
};

/**********Remember ngx_core_module is the gloable config parse!Top layer!!!******/
...
//--------------------------->very important----------------!!!!!!!!!!!!!!!!
//Here,initialize the module's index,This index Means the really order in the ngx_modules!This index is level 1 index!!!!
    ngx_max_module = 0;
    for (i = 0; ngx_modules[i]; i++) {
        ngx_modules[i]->index = ngx_max_module++;
    }

    cycle = ngx_init_cycle(&init_cycle); /**The main initilize of nginx!!!**/
    if (cycle == NULL) {
        if (ngx_test_config) {
	...
	//Here,the master will process the signal operation!
    if (ngx_signal) {
    ...
    ngx_cycle = cycle;	//Here,we Set the cycle as the global cycle!!!
