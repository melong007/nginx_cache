...
ngx_output_chain(ngx_output_chain_ctx_t *ctx, ngx_chain_t *in)
{
    ...
    for ( ;; ) {
        ...
        last = ctx->output_filter(ctx->filter_ctx, out);//Here,call the output filter!!!
...
ngx_chain_writer(void *data, ngx_chain_t *in)
{
    ...
    //Call the send_handler to send data!!
    ctx->out = c->send_chain(c, ctx->out, ctx->limit);//Call the connection io handler!!!
