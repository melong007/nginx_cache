...
struct ngx_event_s {
    void            *data;
    unsigned         write:1;
    unsigned         accept:1;//mark this event use for accept request!!!
...
#else
    struct aiocb     aiocb;	//Here,Use the aio struct to read data!!!
#endif
...
typedef struct {
    ...
    ngx_uint_t    use;//Means use which event_module,this save the pointed event_module->ctx_index!!!
